    ...
    public class KhuyenMaiDao
    {
        ...
        public bool Update(KhuyenMai entity)
        {
            try
            {
                ...
                km.NgayBatDau = entity.NgayBatDau;
                km.NgayKetThuc = entity.NgayKetThuc;
                km.MoTa = entity.MoTa;
        ...
        public bool IsTenKhuyenMaiExists(string tenKhuyenMai)
        {
            // Check if the name already exists in the database
            return db.KhuyenMais.Any(km => km.TenKM == tenKhuyenMai);
        }
        //
    }
}
