...
namespace doan.Areas.Admin
{
    public class AdminAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute(
              name: "AdminChiTietKhuyenMai",
              url: "admin/khuyen-mai/details/{id}",
              defaults: new { controller = "KhuyenMai", action = "Details", id = UrlParameter.Optional }
          );

            context.MapRoute(
              name: "AdminThemKhuyenMai",
              url: "admin/khuyen-mai/them-khuyen-mai",
              defaults: new { controller = "KhuyenMai", action = "ThemKhuyenMai", id = UrlParameter.Optional }
          );

            context.MapRoute(
              name: "AdminChinhSuaKhuyenMai",
              url: "admin/khuyen-mai/chinh-sua/{id}",
              defaults: new { controller = "KhuyenMai", action = "ChinhSuaKhuyenMai", id = UrlParameter.Optional }
          );
